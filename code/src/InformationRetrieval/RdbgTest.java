...
public class RdbgTest {
    String indexDir="F:/IntelliJ IDEA 2019.1/project/WebMining/src/InformationRetrieval.rdbgidx";
    String filesDir = "F:/IntelliJ IDEA 2019.1/project/WebMining/src/InformationRetrieval.rdbg";
    Analyzer textAnalyzer;

    public static void main(String[] args) {
        RdbgTest t = new RdbgTest();
        try {
//			t.buildIndex();
            t.searchIndex();
        } catch (Exception e) {
